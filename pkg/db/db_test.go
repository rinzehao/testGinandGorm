...
func initial() (orderDB OrderDB, sample *model.DemoOrder) {
	...
	db = db.LogMode(true)
	sample = &model.DemoOrder{OrderNo: time.Now().Format("2006-01-02 15:04:05")+queryRandomString(10), UserName: "raious", Amount: 444, Status: "over", FileUrl: ".././pkg/db"}
